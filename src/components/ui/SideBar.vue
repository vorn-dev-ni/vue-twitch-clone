  ...
  >
    ...
    >
      ...
      <nav class="mt-5">
        ...
        <a
          href="#"
          class="mx-auto w-11 h-11 xl:w-auto flex items-center justify-center bg-primary hover:bg-blue-500 py-3 rounded-full text-white font-bold font-sm transition duration-350 ease-in-out mb-10"
        >
          <svg
            fill="currentColor"
            viewBox="0 0 24 24"
      ...
      >
        ...
        <div class="hidden xl:block">
          <div class="flex items-center h-full text-gray-500 dark:text-white">
