<template>
  <div
    role="status"
    class="p-4 border border-gray-600 rounded shadow animate-pulse md:p-6 dark:border-gray-800"
  >
    <div class="flex items-center mt-4 mb-3 ml-3">
      <svg
      ...
      <div>
        <div
          class="h-2.5 bg-gray-400 rounded-full dark:bg-gray-700 w-32 mb-2"
        ></div>
