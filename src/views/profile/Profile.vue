<template>
  <div
    class="text-white lg:col-span-2 col-span-5 sm:col-span-4 flex-col justify-center border-r-[1px] border-l-[1px] border-gray-600 sticky top-0 !bg-black z-20"
  >
    <teleport to="body">
      <keep-alive>
              ...
              <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                >
                  ...
                  >
                    ...
                    <Button
                      type="submit"
                      class="bg-white text-black rounded-xl mb-10 mt-10 duration-1000 transition-all ease-linear hover:bg-slate-500 !ring-0 !ring-offset-0"
                    >
    ...
    <div
      ...
      class="flex gap-3 items-center my-5 pl-5 !sticky !top-0 !bg-black z-50 justify-between md:!justify-normal"
    >
      ...
      <ul class="block md:hidden mr-5" @click="logoff">
        <div
...
export default {
  ...
  watch: {
    tweets() {
      this.postLength = this.getPostByUserLength(this.userId);
      console.log(this.getPostByUserLength(this.userId));
    },
  },
  methods: {
